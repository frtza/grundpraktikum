...
Scipy \cite{scipy} ,Numpy \cite{numpy} und matplotlib \cite{mathplotlib} gearbeitet.
...
Die Tabelle \eqref{tab:gd} beinhaltet die Messwerte für den Stoff \ce{Gd2O3}. Die Werte für die Spannung und die Widerstände
